unit FormScratchPadClass;

interface

uses
  Winapi.Windows, Winapi.Messages, System.Variants, System.Classes, Vcl.Graphics,
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, SuperObject, Vcl.StdCtrls, System.zip,
  IdCookieManager, IdBaseComponent, IdComponent, IdTCPConnection, IdTCPClient, IdHTTP, REST.Types, REST.Client, REST.Authenticator.Basic,
  Data.Bind.Components, Data.Bind.ObjectScope, Vcl.ExtCtrls;

type
  TFormScratchPad = class(TForm)
    Memo: TMemo;
    Image: TImage;
...
uses
  ...
  FPL_Element_Summary, FPL_Images;

{$R *.dfm}

procedure TFormScratchPad.log(const aString: string = ''; beginUpdate: boolean = FALSE);
begin
  case beginUpdate of TRUE: memo.lines.BeginUpdate; end;
  memo.Lines.Add(aString);
end;

procedure TFormScratchPad.logTop;
begin
...
procedure TFormScratchPad.processJSON;
label
  SKIP;
begin
  log('', TRUE);
...
procedure TFormScratchPad.Report_TID_Entry;
...
procedure TFormScratchPad.Report_Transfers;
...
procedure TFormScratchPad.restRequest;
begin
  log('Get:');
  restRequest1.Execute;
  log(restResponse1.Content);
  log(restResponse1.errormessage);
  log('Post:');
  ...
  restClient1.BaseURL := 'https://fantasy.premierleague.com/api/my-team/4206643/';
  restRequest1.Execute;
  log(restResponse1.Content);
  log(restResponse1.errormessage);
end;

procedure TFormScratchPad.Report_Static_Element;
var
  vPhotoID: integer;
begin
//  EXIT;
  ...
  vPhotoID := FPLStaticElements.PlayerPhotoID[388];
  image.Picture.Bitmap.Assign(FPLImages.fetch110x140Photo(vPhotoID));
//  FPLImages.fetch110x140PhotoToFile(78830);
//  FPLImages.fetch250x250PhotoToFile(78830);
  log;

  log ('ELEMENT');
end;

procedure TFormScratchPad.Report_Static_Elements;
...
procedure TFormScratchPad.Report_Static_Element_Stats;
// https://fantasy.premierleague.com/api/bootstrap-static/
var
  oj: ISuperObject;
begin
...
procedure TFormScratchPad.Report_Static_Element_Types;
// https://fantasy.premierleague.com/api/bootstrap-static/
begin
  EXIT;
...
procedure TFormScratchPad.Report_Static_Events;
// https://fantasy.premierleague.com/api/bootstrap-static/
begin
  EXIT;
  log('EVENTS'#13#10);
...
procedure TFormScratchPad.Report_Static_Game_Settings;
// https://fantasy.premierleague.com/api/bootstrap-static/
begin
  EXIT;
...
procedure TFormScratchPad.Report_Static_Phases;
// https://fantasy.premierleague.com/api/bootstrap-static/
begin
  EXIT;
  log('PHASES'#13#10);
...
procedure TFormScratchPad.Report_Static_Teams;
// https://fantasy.premierleague.com/api/bootstrap-static/
begin
  EXIT;
  log('TEAMS'#13#10);
...
procedure TFormScratchPad.Report_Static_Total_Players;
// https://fantasy.premierleague.com/api/bootstrap-static/
begin
  EXIT;
  log('TOTAL_PLAYERS');
...
procedure TFormScratchPad.Report_Fixtures;
...
procedure TFormScratchPad.FormActivate(Sender: TObject);
begin
  processJSON;
end;

procedure TFormScratchPad.FormCreate(Sender: TObject);
begin
  memo.Lines.Clear;
end;

procedure TFormScratchPad.Report_Gameweek;
...
procedure TFormScratchPad.Report_History;
...
procedure TFormScratchPad.Report_Picks;
...
procedure TFormScratchPad.Report_League;
...
procedure TFormScratchPad.Report_Element_Summary;
begin
  EXIT;
  log('PLAYER'#13#10);
...
procedure TFormScratchPad.Report_MyTeam;
begin
  EXIT;
  log('MyTeam'#13#10);
...
var count: integer;
procedure TFormScratchPad.ProcessObject(const aAsObject: TSuperTableString; const aPrefix: string = ''; aPrefixFilter: string = ''; aNameFilter: string = ''; propertyDef: boolean = FALSE);
var
  vNames:         ISuperObject;
  vName:          string;
  vItems:         ISuperObject;
...
//procedure TFormScratchPad.tryInternet;
//var
//  lHTTP: TIdHTTP;
...
// FDR - Fixture Difficulty Rating(s)
